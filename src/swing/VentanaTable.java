...
public class VentanaTable extends javax.swing.JFrame {
    ...
    public void cargarDatosTable() {
       ...
       for(int i=0; i<n1.length; i++) {
           ...
           int menornota = n1[i];
           if(n2[i] < menornota) menornota = n2[i];
           if(n3[i] < menornota) menornota = n3[i];
           if(n4[i] < menornota) menornota = n4[i];
       ...
       dtm.addRow(datosblanco);
       dtm.setValueAt("Pro Clase",5,3);
       String promedioClases = String.format("%5.2f", promedioClase);
       dtm.setValueAt(promedioClases,5,4);
...
public class CustomRenderer extends DefaultTableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        // Check if this is one of the grade columns
