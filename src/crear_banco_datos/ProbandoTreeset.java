...
public class ProbandoTreeset {
    ...
    public static void versionLeerArchivos(){
        ...
        try{
            f = new File("data/BancoDatos/masculino.txt");
            fr = new FileReader(f);
        ...
        try{
            f = new File("data/BancoDatos/femenino.txt");
            fr = new FileReader(f);
            br = new BufferedReader(fr); //Lo pone en el area de preparacion
        ...
        String lastName = "";
        try{
            f = new File("data/BancoDatos/apellido.txt");
            fr = new FileReader(f);
            br = new BufferedReader(fr); //Lo pone en el area de preparacion
        ...
        */
        ...
        try{
            f = new File("data/BancoDatos/persons.csv");
            fw = new FileWriter(f);
